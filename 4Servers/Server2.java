    ...
    static void serverListen() throws IOException, SocketException{
      ...
      while (true) {
        ...
        if(data(dataBytes).length()>4 &&
          ...
          byte[] myPort = Integer.toString(20153).getBytes();
          ...
          // Socket clientSocket = new Socket(InetAddress.getLocalHost(), 20154);
          // DataOutputStream outToServer = new DataOutputStream(clientSocket.getOutputStream());
          // outToServer.write(dataBytes, 0, dataBytes.length);
          InetAddress nextServerIP = InetAddress.getLocalHost();
          Socket clientSocket = new Socket(nextServerIP, 20154);
          DataOutputStream outToServer = new DataOutputStream(clientSocket.getOutputStream());
          outToServer.writeInt(dataBytes.length);
          outToServer.write(dataBytes, 0, dataBytes.length);
        }
